...
import 'package:flutter_absensi/core/ml/recognition_embedding.dart';
import 'package:flutter_absensi/core/ml/recognizer.dart';
...
class RegisterFaceAttendencePage extends StatefulWidget {
  ...
  @override
  State<RegisterFaceAttendencePage> createState() => _RegisterFaceAttendencePageState();
}

class _RegisterFaceAttendencePageState extends State<RegisterFaceAttendencePage> {
...
//TODO initialize face detector
  ...
  InputImage getInputImage() {
    ...
    final int bytesPerRow = frame?.planes.isNotEmpty == true ? frame!.planes.first.bytesPerRow : 0;
  ...
  performFaceRecognition(List<Face> faces) async {
    ...
    for (Face face in faces) {
      ...
      RecognitionEmbedding recognition = recognizer.recognize(croppedFace, face.boundingBox);
  ...
  Future<XFile> convertImageToXFile(img.Image image) async {
    // Encode the img.Image to Uint8List
    Uint8List encodedImage = img.encodePng(image);
  ...
  void showFaceRegistrationDialogue(img.Image croppedFace, RecognitionEmbedding recognition) {
    showDialog(
      context: context,
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: BlocConsumer<UpdateUserRegisterFaceBloc, UpdateUserRegisterFaceState>(
