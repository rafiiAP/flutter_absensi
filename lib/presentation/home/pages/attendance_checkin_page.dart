...
class _AttendanceCheckinPageState extends State<AttendanceCheckinPage> {
  ...
  void _takeAbsen() async {
    if (mounted) {
      context.read<CheckinAttendanceBloc>().add(
            CheckinAttendanceEvent.checkin(latitude.toString(), longitude.toString()),
          );
    }
  }
  ...
  Future<void> getCurrentPosition() async {
    try {
      ...
      if (e.code == 'IO_ERROR') {
        debugPrint('A network error occurred trying to lookup the supplied coordinates: ${e.message}');
      } else {
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isFaceRegistered ? AppColors.primary.withOpacity(0.47) : AppColors.red.withOpacity(0.47),
                            ...
                            return state.maybeWhen(
                              orElse: () {
                                return IconButton(
                                  ...
                                  color: isFaceRegistered ? AppColors.red : AppColors.grey,
                                );
                              },
